...
class Board:
    Board = [["wR", "wK", "wB", "wQ", "wKK", "wB", "wK", "wR"], ["wP", "wP", "wP", "wP", "wP", "wP", "wP", "wP"],
             ["--", "--", "--", "--", "--", "--", "--", "--"], ["--", "--", "--", "--", "--", "--", "--", "--"],
             ["--", "--", "--", "--", "--", "--", "--", "--"], ["--", "--", "--", "--", "--", "--", "--", "--"],
             ["bP", "bP", "bP", "bP", "bP", "bP", "bP", "bP"], ["bR", "bK", "bB", "bKK", "bQ", "bB", "bK", "bR"]]
    ...
    WhitePieces = {0: "wR", 1: "wK", 2: "wB", 3: "wQ", 4: "wKK", 5: "wB", 6: "wK", 7: "wR", 8: "wP", 9: "wP", 10: "wP",
                   11: "wP", 12: "wP", 13: "wP", 14: "wP", 15: "wP"}

    BlackPieces = {48: "bP", 49: "bP", 50: "bP", 51: "bP", 52: "bP", 53: "bP", 54: "bP", 55: "bP", 56: "bR", 57: "bK",
                   58: "bB", 59: "bKK", 60: "bQ", 61: "bB", 62: "bK", 63: "bR"}
    ...
    def Check(self, KingsPiece):
        ...
        if ((KingsPiece[0] + 2) <= 7 and (KingsPiece[1] - 1) >= 0 and (KingsPiece[1] - 1) <= 7 and (
                KingsPiece[0] + 2) >= 0):
        ...
        if ((KingsPiece[0] + 1) >= 0 and (KingsPiece[1] + 2) <= 7 and (KingsPiece[1] + 2) >= 0 and (
                KingsPiece[0] + 1) <= 7):
        ...
        if ((KingsPiece[0] + 1) <= 7 and (KingsPiece[1] - 2) >= 0 and (KingsPiece[1] - 2) <= 7 and (
                KingsPiece[0] + 1) >= 0):
        ...
        if ((KingsPiece[0] - 2) >= 0 and (KingsPiece[1] - 1) >= 0 and (KingsPiece[1] - 1) <= 7 and (
                KingsPiece[0] - 2) <= 7):
        ...
        if ((KingsPiece[0] - 2) >= 0 and (KingsPiece[1] + 1) <= 7 and (KingsPiece[1] + 1) >= 0 and (
                KingsPiece[0] - 2) <= 7):
        ...
        if ((KingsPiece[0] - 1) <= 7 and (KingsPiece[1] + 2) <= 7 and (KingsPiece[1] + 2) >= 0 and (
                KingsPiece[0] - 1) >= 0):
        ...
        if ((KingsPiece[0] - 1) >= 0 and (KingsPiece[1] - 2) >= 0 and (KingsPiece[1] - 2) <= 7 and (
                KingsPiece[0] - 1) <= 7):
        ...
        for x in range(1, KingsPiece[0] + 1, 1):
            try:
                if (self.Board[KingsPiece[0] - x][KingsPiece[1] - x] != "--" and (KingsPiece[1] - x) >= 0 and (
                        KingsPiece[0] - x >= 0)):
                    if (self.Board[KingsPiece[0] - x][KingsPiece[1] - x] == Q or self.Board[KingsPiece[0] - x][
                        KingsPiece[1] - x] == B):
        ...
        for x in range(KingsPiece[0] + 1, 8, 1):
            ...
            try:
                if (self.Board[x][KingsPiece[1] - RC] != "--" and KingsPiece[1]):
                    if ((self.Board[x][KingsPiece[1] - RC] == Q or self.Board[x][KingsPiece[1] - RC] == B) and
                            KingsPiece[1] - RC >= 0):
                        return True
                    else:
                        break
    ...
    def CheckMate(self, KingsPiece):
      ...
      tempKingsPieceUL[0] = tempKingsPieceUL[0] - 1
        ...
        if (tempKingsPieceUL[0] >= 0 and tempKingsPieceUL[0] <= 7 and tempKingsPieceUL[1] >= 0 and tempKingsPieceUL[
            1] <= 7):
        ...
        if (tempKingsPieceDL[0] >= 0 and tempKingsPieceDL[0] <= 7 and tempKingsPieceDL[1] >= 0 and tempKingsPieceDL[
            1] <= 7):
            if (self.Check(tempKingsPieceDL)):
                PCSafeSpace[6] = 1
            # return True
      if (tempKingsPieceUR[0] >= 0 and tempKingsPieceUR[0] <= 7 and tempKingsPieceUR[1] >= 0 and tempKingsPieceUR[
            1] <= 7):
            if (self.Check(tempKingsPieceUR)):
                PCSafeSpace[2] = 1
            # return True
        if (tempKingsPieceDR[0] >= 0 and tempKingsPieceDR[0] <= 7 and tempKingsPieceDR[1] >= 0 and tempKingsPieceDR[
            1] <= 7):
    ...
    def BlockCheck(self, TestPeice):
        ...
        if ((abs(KingsPiece[0] - TestPeice[0]) == 1 or abs(KingsPiece[0] - TestPeice[0]) == 0) and (
                abs(KingsPiece[1] - TestPeice[1]) == 1 or abs(KingsPiece[1] - TestPeice[1]) == 0)):
...
def CheckReturnPiece(self, ComparePiece):
    ...
    for x in range(KingsPiece[0] + 1, 8, 1):
        ...
        try:
            if (self.Board[x][KingsPiece[1] - RC] != "--" and KingsPiece[1]):
                if ((self.Board[x][KingsPiece[1] - RC] == Q or self.Board[x][KingsPiece[1] - RC] == B) and KingsPiece[
                    1] - RC >= 0):
